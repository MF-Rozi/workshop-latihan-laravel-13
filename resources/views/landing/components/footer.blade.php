    ...
    <div class="container">
            ...
            <div class="col-lg-12 text-center">
                <div class="footer_social">
                    <ul>
                        ...
                        <li><a data-toggle="tooltip" data-placement="top" title="Twitter" href="#"><i class="fa fa-instagram"></i></a>
                        </li>
        ...
        <div class="row footer-padding">
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12">
                <div class="single_footer">
                    ...
                    <div class="footer_contact">
                        <ul>
                            <li><a href="{{ asset('storage/assets/pages/about.html') }}">About us</a></li>
                            <li><a href="{{ asset('storage/assets/pages/customer-service.html') }}">Customer Service</a></li>
                            <li><a href="{{ asset('storage/assets/pages/company.html') }}">Company</a></li>
                            <li><a href="{{ asset('storage/assets/pages/investor-relations.html') }}">Investor Relations</a></li>
                            <li><a href="{{ asset('storage/assets/pages/advanced-search.html') }}">Advanced Search</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row text-center">
            <div class="col-lg-12 col-sm-12 col-xs-12 wow zoomIn">
                <p class="footer_copyright">Hilux &copy; 2026 All Rights Reserved. Distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a></p>.
            </div>
            <!--- END COL -->
        </div>
        <!--- END ROW -->
